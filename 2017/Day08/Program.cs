...
namespace Day08
{
    ...
    class Program
    {
        ...
        static void ProblemOne(List<Instruction> instructions)
        {
        ...
        static bool ExecuteInstruction(int registerValue, string operator_, int number)
        {
            switch (operator_)
            {
                case "==":
        ...
        private static string Input = @"d dec 461 if oiy <= 1
...
fu inc 131 if rjt == 4175a;

        private static string Example = @ab inc 5 if a > 1
a inc 1 if b < 5
c dec -10 if a >= 1
c inc -20 if c == 10";
