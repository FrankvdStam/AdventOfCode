...
namespace Day07
{
    ...
    class Program
    {
        ...
        static void WriteNode(Node n, int height)
        {
        ...
        static Node ParseInput(string input)
        {
            ...
            //First pass: create node object for each node and add them to the lookup
        ...
        private static string Input = @"ifyzcgi (14)
axjvvur (50)
...
swnafht (44) -> lbxdtms, jensj, zkpfzio, jobwpao, jxfimbl";
        ...
        private static string Example = @"pbga (66)
xhth (57)
ebii (61)
havc (66)
ktlj (57)
