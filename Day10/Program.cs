...
namespace Day10
{
    ...
    class Program
    {
        ...
        static int FindBiggestDistance(List<Light> lights)
        {
        ...
        static List<Light> ParseInput(bool useExampleData)
        {
            if (useExampleData)
            {
        ...
        static void ProgresSeconds(int seconds, List<Light> lights)
        {
        ...
        static List<Light> MoveToOrigin(List<Light> lights)
        {
        ...
        static List<Light> Normalize(List<Light> lights)
        {
            var result = new List<Light>();
            Vector2i correction = new Vector2i()
            {
        ...
        static void Draw(List<Light> lights)
        {
            Console.Clear();
            foreach(Light l in lights)
            {
        ...
        static List<Light> ParseInput(string input, int positionSize, int velocitySize)
        {
        ...
        static string example = @"position=< 9,  1> velocity=< 0,  2>
...
position=<-3,  6> velocity=< 2, -1>";
        ...
        static string input = @"position=< 20316, -30055> velocity=<-2,  3>
