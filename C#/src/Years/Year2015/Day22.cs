...
namespace Years.Year2015
{
    ...
    //Stolen from reddit user CdiTheKing    
    ...
    public class Day22 : IDay
    {
        ...
        private const string Input = @"Hit Points: 55
Damage: 8";
        ...
        public void ProblemOne()
        {
            ...
            queueOfStates.Enqueue(new GameState(false));
            ...
            while (queueOfStates.Count > 0)
            {
                ...
                foreach (var spell in spells.Except(gameState.ActiveSpells.Keys)
                    .Where(x => gameState.PlayerMana >= x.Mana))
                {
        ...
        class GameState
        {
            ...
            {
                foreach(var k in ActiveSpells.Keys)
                {
                    ProcessSpell(k);
                }
