...
namespace Years.Year2019
{
    public class Day03 : IDay
    {
        ...
        public void ProblemOne()
        {
            ...
            int result = FindMinimumManhattanDistanceOfIntersectedLines(split[0], split[1]);
        ...
        {
            var split = Input.Split(new string[] { "\r\n" }, StringSplitOptions.None);
            int result = FindMinimumNumberOfStepsToIntersection(split[0], split[1]);
            Console.WriteLine(result);
        }


        private int FindMinimumNumberOfStepsToIntersection(string line1, string line2)
        {
        ...
        private int FindMinimumManhattanDistanceOfIntersectedLines(string line1, string line2)
        {
            List<Vector2i> line1Vectors = ParseLine(line1);
            List<Vector2i> line2Vectors = ParseLine(line2);
        ...
        private List<Vector2i> ParseLine(string line)
        {
