...
namespace Day06
{
    class Program
    {
        ...
        static void ProblemOne(string input, int width)
        {
            var lines = input.Split(new string[] { "\r\n" }, StringSplitOptions.None);
            //char[,] chars = new char[width, lines.Length];
        ...
        static char MostAppearingChar(List<char> chars)
        {
        ...
        static char LeastAppearingChar(List<char> chars)
        {
            Dictionary<char, int> dict = new Dictionary<char, int>();
            foreach (char c in chars)
            {
        ...
        private static string Input = @"focdealm
ggsipflx
rvibwxbm
vqrfyyrh
hsjtzpgs
...
qgolehtg
keeskeyb";
        private static string Example = @"eedadn
drvtee
eandsr
raavrd
atevrs
