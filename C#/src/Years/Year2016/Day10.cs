...
namespace Years.Year2016
{
    ...
    public class Day10 : IDay
    {
                ...
                foreach (var line in lines)
                {
                    if (!line.StartsWith("value"))
                    {
                        ...
                        if (giver.ContainsTwoValues)
                        {
                            ...
                            if (giver.Min == 17 && giver.Max == 61)
                            {
                                Console.WriteLine(giver.Id);
                                return;
                            }
        ...
        private const string Example = @"value 5 goes to bot 2
...
value 2 goes to bot 2";
        ...
        private const string Input = @"bot 135 gives low to bot 27 and high to bot 166
