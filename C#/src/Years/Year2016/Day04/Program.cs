...
namespace Day04
{
    class Program
    {
        ...
        static char Shift(char c, int shifts)
        {
            //ascii
            //a: 97
            //z: 122
        ...
        static bool IsReal(string room, out int sectorId)
        {
            sectorId = 0;
        ...
        private static string Input = @"bkwzkqsxq-tovvilokx-nozvyiwoxd-172[fstek]
...
hplazytkpo-prr-cpnptgtyr-379[prtya]";
        ...
        private static string Example = @"aaaaa-bbb-z-y-x-123[abxyz]
