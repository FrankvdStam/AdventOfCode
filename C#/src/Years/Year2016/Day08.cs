...
namespace Years.Year2016
{
    public class Day08 : IDay
    {
            ...
            foreach (var line in lines)
            {
                ...
                switch (bits[0])
                {
                    ...
                    case "rotate":
                        ...
                        if (bits[1] == "column")
                        {
                            _pixels = RotateX(_pixels, columnOrRow, amount);
                        }
                        else
                        {
                            _pixels = RotateY(_pixels, columnOrRow, amount);
                        }
                        break;
                }
            }
        ...
        private bool[,] Copy(bool[,] boolArray)
        {
        ...
        private bool[,] Rect(bool[,] pixels, int width, int height)
        {
        ...
        private bool[,] RotateX(bool[,] pixels, int column, int amount)
        {
        ...
        private bool[,] RotateY(bool[,] pixels, int row, int amount)
        {
        ...
        private const string Example = @"rect 3x2
