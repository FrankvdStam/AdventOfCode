...
namespace Years.Year2017
{
    public class Day13 : IDay
    {
        ...
        public void ProblemOne()
        {
            ...
            Console.WriteLine(CalculateScore(input, 0, out _));
        }
        ...
        private int CalculateScore(int[] depts, int delay, out bool detected)
        {
            detected = false;
            int score = 0;
        ...
        private int CalculatePosition(int time, int dept)
        {
        ...
        private void Print(int time, int[] state, int? position = null)
        {
        ...
        private const string Example = @"0: 3
1: 2
4: 4
6: 4";

        private const string Input = @"0: 4
1: 2
2: 3
4: 4
6: 8
