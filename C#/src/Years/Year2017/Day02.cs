...
namespace Years.Year2017
{
    public class Day02 : IDay
    {
        ...
        private bool AreEvenDivisible(decimal a, decimal b, out decimal division)
        {
            decimal max, min;
        ...
        private int[,] ParseInput(string input, int width, int length)
        {
        ...
        private const string Input = @"62	1649	1731	76	51	1295	349	719	52	1984	2015	2171	981	1809	181	1715
