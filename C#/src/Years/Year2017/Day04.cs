...
namespace Years.Year2017
{
    public class Day04 : IDay
    {
        ...
        private bool CanRearrange(string a, string b)
        {
        ...
        private const string Input = @"nyot babgr babgr kqtu kqtu kzshonp ylyk psqk
...
inc mpys mzqmcwx vryz ibqrzc pmsy fat rojpxwy rcbqzi gjef";
        ...
        private const string Example = @"abcde fghij
abcde xyz ecdab
