...
namespace Years.Year2017
{
    public class Day09 : IDay
    {
        ...
        {
            var input = Input;//Bit contrived, use this to switch to example/input.
