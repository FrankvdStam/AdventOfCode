...
namespace Day05
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ProblemTwo(instructions);
            //ProblemTwo();
        }

        static void ProblemOne(List<int> instructions)
        {
            int steps = 0;
            ...
            {
                int instr = instructions[instructionPointer];
        ...
        static void ProblemTwo(List<int> instructions)
        {
            int steps = 0;
        ...
        private static string Example = @"0
3
0
1
-3";
