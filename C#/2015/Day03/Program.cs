...
namespace Day03
{
    class Program
    {
        ...
        static void GetRoboSize(string input, out int width, out int height, out int x, out int y)
        {
            width = 0;
            height = 0;
            x = 0;
        ...
        static void GetSize(string input, out int width, out int height, out int x, out int y)
        {
            width = 0;
            height = 0;
            x = 0;
