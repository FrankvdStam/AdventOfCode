    ...
    class Program
    {
        ...
        static bool SupportsSsl(string input)
        {
            ...
            for (int i = 0; i + 2 < input.Length; i++)
            {
                ...
                {
                    string sequence = "" + input[i] + input[i + 1] + input[i + 2];
                    if (hypernetSequence)
                    {
            ...
            foreach (var sequence in supernetSequences)
            {
                //Reverse the sequence
                string insideOutSequence = "" + sequence[1] + sequence[0] + sequence[1];

                if (hypernetSequences.Contains(insideOutSequence))
                {
                    return true;
                }
            }
        ...
        private static string Example2 = @"aba[bab]xyz
xyx[xyx]xyx
aaa[kek]eke
zazbz[bzb]cdb";

        private static string Example = @"abba[mnop]qrst
abcd[bddb]xyyx
aaaa[qwer]tyui
ioxxoj[asdfgh]zxcvbn";
        private static string Input = @"rhamaeovmbheijj[hkwbkqzlcscwjkyjulk]ajsxfuemamuqcjccbc
